...
class PyGitReview(PythonPackage):
    ...
    version('1.28.0', 'e5864b4a51419a420dbb6f928b53b78d')  # TODO_SPACK_MERGE_8 sha256sum
    version('1.27.0', 'fddbc66f51d611c10e550b6fe14a2e5e')  # TODO_SPACK_MERGE_8 sha256sum 
