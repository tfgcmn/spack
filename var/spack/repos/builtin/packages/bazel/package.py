...
class Bazel(Package):
    ...
    version('0.19.0', 'dd5347f82482747a6d5cae6d4787b5da')  # TODO_SPACK_MERGE_8: Add sha256
    ...
    # only supports up to java 8, otherwise the build will fail
